    ...
    <q-page class="main-content">
      <div class="hero-section">
        <div class="hero-content">
          <h1 class="hero-title">
            <span class="hero-highlight">Seus Favoritos</span>
            <span class="hero-subtitle">Vídeos que você salvou</span>
          </h1>
        </div>
      </div>
      ...
      <div class="favorites-container">
        ...
        <q-list class="favorites-list" v-if="favorites.length">
          <q-item
        ...
        <div v-else class="no-favorites">
          <q-icon name="favorite_border" size="xl" color="grey-6" class="q-mb-sm" />
          <p>Nenhum vídeo favoritado ainda.</p>
        </div>
      </div>
    </q-page>
